...
public class ModelLizard extends ModelBase {
    ...
    public ModelLizard() {
        ...
        this.Bipedhead = new ModelRenderer(this, 0, 24);
        this.Bipedhead.setRotationPoint(0.0F, -2.5F, -6.0F);
        this.Bipedhead.addBox(-2.0F, -2.5F, -2.0F, 4, 5, 3, 0.0F);
        this.setRotateAngle(Bipedhead, 0.31869712141416456F, 0.0F, 0.0F);
